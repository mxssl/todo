...
var exampleFlags = struct {
	Example string `long:"example" description:"Example"`
}{}
...
func configureServer(s *http.Server, scheme, addr string) {
	// if exampleFlags.Example != "something" {
	// 	fmt.Print("Example argument is not something")
	// }
}
